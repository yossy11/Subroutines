     ...
     & calc_FlowStress,dfdS(6),dGdS(6),eqGStress,dLambda,F,H,lambda
      ...
      ! define constants
      PARAMETER(TOLER=1.0D-5,YOUNG=22.58D4,POISSON=0.39D0,HARDQ=413.9D0,
     & HARDB=67.644D0,HARDSTRESS0=655.9D0,YLDM=6.0D0)
     ...
     &       HARDQ,HARDB,HARDSTRESS0,eqpStrain)
          END IF
          RETURN
        END IF
     ...
     & lambda,eqStress,HARDQ,HARDB,HARDSTRESS0,
