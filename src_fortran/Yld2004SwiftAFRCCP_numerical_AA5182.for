     ...
     & HARDN=0.363D0,HARDSTRAIN0=0.00761D0,YLDM=8)
      ...
      yldCPrime(1,2) = -0.996102815440549D0
      yldCPrime(1,3) = -1.0205657815072584D0
      yldCPrime(2,1) = -0.9861077211369444D0
      yldCPrime(2,3) = -1.0264557576541147D0
      yldCPrime(3,1) = -1.0304394936707337D0
      yldCPrime(3,2) = -1.0164216256212755D0
      yldCPrime(4,4) = 1.0025549852448257D0
      yldCPrime(5,5) = 0.8D0
      yldCPrime(6,6) = 0.8D0

      yldCDbPrime(1,2) = -0.9962051815774844D0
      yldCDbPrime(1,3) = -1.0204263181165631D0
      yldCDbPrime(2,1) = -0.9862915474543241D0
      yldCDbPrime(2,3) = -1.0262777596984725D0
      yldCDbPrime(3,1) = -1.0304996400581952D0
      yldCDbPrime(3,2) = -1.016402765486338D0
      yldCDbPrime(4,4) = 1.0025294199152772D0
      yldCDbPrime(5,5) = 0.8D0
      yldCDbPrime(6,6) = 0.8D0
