     ...
     & HARDSTRESS0=519.73D0,YLDM=6.0D0)
      ...
      g_yldCPrime(1,2) = -0.978676811742272D0
      g_yldCPrime(1,3) = -1.0155655137865276D0
      g_yldCPrime(2,1) = -0.956293501571447D0
      g_yldCPrime(2,3) = -0.9923044145704766D0
      g_yldCPrime(3,1) = -1.0379668696483502D0
      g_yldCPrime(3,2) = -0.9699665765886128D0
      g_yldCPrime(4,4) = 1.0229368224938618D0
      g_yldCPrime(5,5) = 1.0D0
      g_yldCPrime(6,6) = 1.0D0
      
      g_yldCDbPrime(1,2) = -0.978658158833893D0
      g_yldCDbPrime(1,3) = -1.0156280173593986D0
      g_yldCDbPrime(2,1) = -0.9563282984646336D0
      g_yldCDbPrime(2,3) = -0.992335717702875D0
      g_yldCDbPrime(3,1) = -1.037930467713471D0
      g_yldCDbPrime(3,2) = -0.9699600496984562D0
      g_yldCDbPrime(4,4) = 1.0229238225580262D0
