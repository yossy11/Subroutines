     ...
     & HARDN=0.227D0,HARDSTRAIN0=2.5D-2)
      ...
      DO WHILE (iterationNum < 1000000)
        ...
        eqStress = calc_eqStress(hillGParams,STRESS)
        ...
        IF (F < flowStress*TOLER) THEN
          ...
          IF (iterationNum /= 0) THEN
            CALL updateDDSDDE(hillGParams,STRESS,DDSDDE,
     &       lambda,eqStress,HARDK,HARDN,HARDSTRAIN0,eqpStrain)
        ...
        CALL calc_dfdS(hillGParams,STRESS,dfdS)
     ...
     & HARDN,eqpStrain)
      ...
      SUBROUTINE updateDDSDDE(hillGParams,STRESS,DDSDDE,
     & lambda,eqStress,HARDK,HARDN,HARDSTRAIN0,eqpStrain)
      IMPLICIT NONE
      INTEGER i,j
      DOUBLE PRECISION hillGParams(4),STRESS(6),
