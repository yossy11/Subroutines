      ...
      DO WHILE (iterationNum < 1000000)
        ...
        IF (F < flowStress*TOLER) THEN
          ...
          IF (iterationNum /= 0) THEN
            CALL updateDDSDDE(hillFParams,STRESS,DDSDDE,
     ...
     & HARDN,eqpStrain)
      ...
      SUBROUTINE updateDDSDDE(hillFParams,STRESS,DDSDDE,
     & lambda,eqStress,HARDK,HARDN,HARDSTRAIN0,eqpStrain)
      IMPLICIT NONE
      INTEGER i,j
      DOUBLE PRECISION hillFParams(4),STRESS(6),
     ...
     & vec2(7),H,C(7,7),subDDSDDE(6,6)
      ...
      CALL calc_dfdS(hillFParams,STRESS,dfdS)
      CALL calc_dGdS(hillFParams,STRESS,dGdS)
      CALL calc_ddGddS(hillFParams,STRESS,dGdS,ddGddS)
