     ...
     & HARDSTRESS0=519.73D0,YLDM=6.0D0)
      ...
      yldCPrime(1,2) = -0.9821539246198124D0
      yldCPrime(1,3) = -1.016247297800221D0
      yldCPrime(2,1) = -0.9729007462726103D0
      yldCPrime(2,3) = -0.9937171620627243D0
      yldCPrime(3,1) = -1.025380829900888D0
      yldCPrime(3,2) = -0.9846366340527765D0
      yldCPrime(4,4) = 1.011868280897356D0
      yldCPrime(5,5) = 1.0D0
      yldCPrime(6,6) = 1.0D0

      yldCDbPrime(1,2) = -0.9821429549798266D0
      yldCDbPrime(1,3) = -1.0163109473834446D0
      yldCDbPrime(2,1) = -0.9730928736280997D0
      yldCDbPrime(2,3) = -0.9937337927111698D0
      yldCDbPrime(3,1) = -1.0254718751198486D0
      yldCDbPrime(3,2) = -0.9845101646643356D0
      yldCDbPrime(4,4) = 1.0116904428635412D0
      yldCDbPrime(5,5) = 1.0D0
      yldCDbPrime(6,6) = 1.0D0

      hillParams(1) = 0.42610421732178394D0
      hillParams(2) = 0.5913660555884093D0
      hillParams(3) = 0.4086339444115908D0
      hillParams(4) = 1.5770789230107995D0
