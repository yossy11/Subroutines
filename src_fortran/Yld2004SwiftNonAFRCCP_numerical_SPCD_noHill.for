     ...
     & HARDN=0.25D0,HARDSTRAIN0=4.0D-3,YLDM=6)

      ! anisotropic params
      f_yldCPrime(:,:) = 0.0D0
      f_yldCDbPrime(:,:) = 0.0D0

      f_yldCPrime(1,2) = -1.0590715128541293D0
      f_yldCPrime(1,3) = -0.9091655536077701D0
      f_yldCPrime(2,1) = -1.0355525653313848D0
      f_yldCPrime(2,3) = -0.9547673849833314D0
      f_yldCPrime(3,1) = -0.9327141857498963D0
      f_yldCPrime(3,2) = -0.93108505465565D0
      f_yldCPrime(4,4) = 1.037572617217133D0
      f_yldCPrime(5,5) = 1.0D0
      f_yldCPrime(6,6) = 1.0D0

      f_yldCDbPrime(1,2) = -1.0592681245280733D0
      f_yldCDbPrime(1,3) = -0.9090174344899047D0
      f_yldCDbPrime(2,1) = -1.0354687059206593D0
      f_yldCDbPrime(2,3) = -0.9546929147971359D0
      f_yldCDbPrime(3,1) = -0.9328265220040074D0
      f_yldCDbPrime(3,2) = -0.9310373689470788D0
      f_yldCDbPrime(4,4) = 1.0374821617151109D0
      ...
      g_yldCPrime(1,2) = -1.0485390715522567D0
      g_yldCPrime(1,3) = -0.9923938349506232D0
      g_yldCPrime(2,1) = -1.0500032540512731D0
      g_yldCPrime(2,3) = -0.9701686698126688D0
      g_yldCPrime(3,1) = -0.9909693696021967D0
      g_yldCPrime(3,2) = -0.9713829937846303D0
      g_yldCPrime(4,4) = 0.9880837809646718D0
      g_yldCPrime(5,5) = 1.0D0
      g_yldCPrime(6,6) = 1.0D0

      g_yldCDbPrime(1,2) = -1.0488218303125092D0
      g_yldCDbPrime(1,3) = -0.9921623369749469D0
      g_yldCDbPrime(2,1) = -1.0498966131635172D0
      g_yldCDbPrime(2,3) = -0.9701165937801292D0
      g_yldCDbPrime(3,1) = -0.9910852781892462D0
      g_yldCDbPrime(3,2) = -0.9714199000088642D0
      g_yldCDbPrime(4,4) = 0.9879708549219542D0
