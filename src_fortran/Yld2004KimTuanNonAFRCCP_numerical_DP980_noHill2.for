     ...
     & HARDSTRESS0=519.73D0,YLDM=6.0D0)
      ...
      g_yldCPrime(1,2) = -0.9821539246198124D0
      g_yldCPrime(1,3) = -1.016247297800221D0
      g_yldCPrime(2,1) = -0.9729007462726103D0
      g_yldCPrime(2,3) = -0.9937171620627243D0
      g_yldCPrime(3,1) = -1.025380829900888D0
      g_yldCPrime(3,2) = -0.9846366340527765D0
      g_yldCPrime(4,4) = 1.011868280897356D0
      g_yldCPrime(5,5) = 1.0D0
      g_yldCPrime(6,6) = 1.0D0

      g_yldCDbPrime(1,2) = -0.9821429549798266D0
      g_yldCDbPrime(1,3) = -1.0163109473834446D0
      g_yldCDbPrime(2,1) = -0.9730928736280997D0
      g_yldCDbPrime(2,3) = -0.9937337927111698D0
      g_yldCDbPrime(3,1) = -1.0254718751198486D0
      g_yldCDbPrime(3,2) = -0.9845101646643356D0
      g_yldCDbPrime(4,4) = 1.0116904428635412D0
      ...
      f_yldCPrime(1,2) = -0.9630755236085117D0
      f_yldCPrime(1,3) = -1.0404635133877267D0
      f_yldCPrime(2,1) = -0.9671641135689687D0
      f_yldCPrime(2,3) = -0.9666250667631737D0
      f_yldCPrime(3,1) = -1.0364152750397875D0
      f_yldCPrime(3,2) = -0.9707464664422254D0
      f_yldCPrime(4,4) = 1.0278975580349605D0
      f_yldCPrime(5,5) = 1.0D0
      f_yldCPrime(6,6) = 1.0D0

      f_yldCDbPrime(1,2) = -0.9630621276929356D0
      f_yldCDbPrime(1,3) = -1.0405349522836391D0
      f_yldCDbPrime(2,1) = -0.9671784592047932D0
      f_yldCDbPrime(2,3) = -0.9666518844943464D0
      f_yldCDbPrime(3,1) = -1.0363759388697624D0
      f_yldCDbPrime(3,2) = -0.9707396235439515D0
      f_yldCDbPrime(4,4) = 1.027884484472155D0
